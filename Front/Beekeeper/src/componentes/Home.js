    ...
    return (
        <div className="gestion-container">
            ...
            <div className="stats-grid-dashboard animate-fade-in" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '30px', marginTop: '20px' }}>
                <div className="stat-card highlight" style={{ padding: '40px', minHeight: '220px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                    <label>Entorno</label>
                    <h2>Apiarios</h2>
                    <p>Gestiona tus asentamientos, define la flora predominante y controla la geolocalización exacta de cada zona de pecoreo.</p>
                </div>

                <div className="stat-card " style={{ padding: '40px', minHeight: '220px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                ...
                <div className="stat-card highlight" style={{ gridColumn: 'span 2', padding: '50px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', minHeight: '200px', justifyContent: 'center' }}>
